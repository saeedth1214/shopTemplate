                                    ...
                                    <form onSubmit={ handleRegisterForm }>
                                        <div className="row">
                                            ...
                                            <div className="form-group col-md-12 mb-4">
                                                <input type="text" className="form-control input-lg" name="fullname" placeholder="fullname" autoComplete="true" onChange={ e => setUserName(e.target.value) } />
                                                { validator.current.message('fullname', fullname, "required|min:3|max:15") }
                                            </div>
                                            <div className="form-group col-md-12 mb-4">
                                                <input type="email" className="form-control input-lg" name="email" placeholder="email" autoComplete="true" onChange={ e => setEmail(e.target.value) } />
                                                { validator.current.message("email", email, "required|email") }
                                            </div>

                                            <div className="form-group col-md-12 ">
                                                <input type="password" className="form-control input-lg" name="password" value={ password } placeholder="Password" onChange={ e => setPassword(e.target.value) } />
                                                { validator.current.message("Password", password, "required|alpha_num|min:8|max:15") }

                                            </div>
                                            <div className="form-group col-md-12 ">
                                                <input type="password" className="form-control input-lg" name="cpassword" value={ confrimPassword } placeholder="Confirm Password" onChange={ e => setConfrimPassword(e.target.value) } />
